  ...
  return [
    ...
    },
    {
      ...
      items: sorted([
        ...
        { text: 'Field Plugins', link: `${prefix}/guides/field-plugins` },
  ...
  return [
    {
      ...
      items: sorted([
        ...
        { text: 'Audit log', link: `${prefix}/ui/audit-logs` },
        { text: 'Space settings', link: `${prefix}/ui/settings` },
        { text: 'Subscription and billing', link: `${prefix}/ui/subscription` },
        { text: 'Agency billing', link: `${prefix}/ui/agency-billing` },
        { text: 'Account, teams, and spaces', link: `${prefix}/ui/account` },
      ]),
    },
  ]
}
